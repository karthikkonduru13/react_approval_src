...
function ApproveAccount() {
  function FunAccountReject(params) {
    params.preventDefault()
    alert("FunAccountReject")
  }

  function FunAccountApprove(params) {
    params.preventDefault()
    alert("FunAccountApprove")
  }
  return (
    <>
        ...
        <div className="container background-color-body margin_10px input_text_body input_text_body_submit">
          <div className="row">
            <div className="col-25">
              <label htmlFor="fname">First Name - Account</label>
            </div>
          ...
          <div className="row13 padding_row">
            <input onClick={FunAccountReject} type="submit" value="Reject" />
            <input onClick={FunAccountApprove} type="submit" value="Approve" />
          </div>
        </div>
      </div>
    </>
