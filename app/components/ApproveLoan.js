...
function ApproveLoan() {
  function FunLoanApprove(params) {
    params.preventDefault()
    alert("FunLoanApprove")
  }

  function FunLoanReject(params) {
    params.preventDefault("FunLoanReject")
    alert("FunLoanReject")
  }
        ...
        <div className="container background-color-body margin_10px input_text_body input_text_body_submit">
          <div className="row">
            <div className="col-25">
              <label htmlFor="fname">First Name - Loan</label>
            </div>
          ...
          <div className="row13 padding_row">
            <input onClick={FunLoanReject} type="submit" value="Reject" />
            <input onClick={FunLoanApprove} type="submit" value="Approve" />
          </div>
        </div>
      </div>
    </>
